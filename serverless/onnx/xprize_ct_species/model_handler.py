...
class ModelHandler:
    ...
    def letterbox(self, im, new_shape=(224, 224), color=(114, 114, 114), auto=True, scaleup=True, stride=32):
    ...
    def _infer(self, inputs: np.ndarray):
        try:
            ...
            # Reshape to 1D array
            predictions = detections.reshape(-1)
            ...
            labels = str(predicted_class_label)
            ...
            try:
                ...
                raise Exception(f"Cannot print output: {e}")
        ...
        if detections:
            ...
            if scores >= threshold:
                ...
                results.append({
                    ...
                    "label": self.labels.get(labels, labels),
